<div class="accordion accordion-flush " id="aside-menu">
    <div class="accordion-item ">
        ...
        <div id="aside-product-control" class="accordion-collapse collapse" aria-labelledby="aside-product-title"
    ...
    <div class="accordion-item">
        <h2 class="accordion-header" id="aside-user-title">
            <button class="accordion-button collapsed ps-5" type="button" data-bs-toggle="collapse"
                data-bs-target="#aside-user-control" aria-expanded="false" aria-controls="aside-user-control">
                會員管理
            </button>
        </h2>
        <div id="aside-user-control" class="accordion-collapse collapse" aria-labelledby="aside-user-title"
            data-bs-parent="#aside-menu">
            <div class="accordion-body p-0 text-center">
                <ul class="list-group">
    ...
    <div class="accordion-item">
        <h2 class="accordion-header" id="aside-order-title">
            <button class="accordion-button collapsed ps-5" type="button" data-bs-toggle="collapse"
                data-bs-target="#aside-order-control" aria-expanded="false" aria-controls="aside-order-control">
                訂單管理
            </button>
        </h2>
        <div id="aside-order-control" class="accordion-collapse collapse" aria-labelledby="aside-order-title"
            data-bs-parent="#aside-menu">
            <div class="accordion-body p-0 text-center">
                <ul class="list-group">
                    ...
                    <li class="list-group-item"><a
                            href="../page/index.php?current=order-item-filter&id_type=order_info&id=1&order_info=">訂單篩選</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="accordion-item">
        ...
        <div id="aside-coupon-control" class="accordion-collapse collapse" aria-labelledby="aside-coupon-title"
            data-bs-parent="#aside-menu">
            <div class="accordion-body p-0 text-center">
                <ul class="list-group">
