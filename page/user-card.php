...
<h3>會員一覽(方塊)</h3>
<div class="text-end">
    <a href="../page/index.php?current=user"><img src="../img/icon/menu.png" alt="sections.png" class="mx-3"
            ...
            <div class="row">
                <div class="btn-group  mb-1" role="group" aria-label="Basic outlined example">
                    <button type="button" class="btn btn-outline-primary"><a
                            href="http://localhost:8080/project/page/index.php?id_type=user&id=<?= $row["id"] ?>&current=order-item-filter">訂單</a></button>
                    <button type="button" class="btn btn-outline-primary"><a
                            href="http://localhost:8080/project/page/index.php?current=user-favorite2&id_type=user&id=<?= $row["id"] ?>">收藏</a></button>
                </div>
            </div>
            <div class="row">
                <div class="btn-group  mb-3" role="group" aria-label="Basic outlined example">
                    <button type="button" class="btn btn-outline-primary"><a
                            href="http://localhost:8080/project/components/edit-user.php?id=<?= $row["id"] ?>">變更</a>
                    </button>
                    <button type="button" class="btn btn-outline-primary"><a
                            href="http://localhost:8080/project/components/delete-user.php?id=<?= $row["id"] ?>">刪除</a></button>
                </div>
    ...
    <nav aria-label="Page navigation example">
        <ul class="pagination">
            ...
            <li class="page-item <?php if ($i == $p) echo "active" ?>"><a class="page-link"
                    href="index.php?current=user-card&p=<?= $i ?>"><?= $i ?></a></li>
            <?php endfor ?>
        </ul>
